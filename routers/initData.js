const initAuth = () => {
  ...
  authResult.forEach((item, index, arr) => {
    let auth_name = item.auth_name;
    let auth_description = item.auth_description;
    // let id = arr.length + 1;
    authResult.push({
      id: arr.length + 1,
...
exports.bulkCreateAuth = initAuth();
exports.bulkCreateRole = initRole();
exports.bulkCreateAuth = initAuth();
exports.bulkCreateRoleAuth = initRoleAuth();
